-- ==========================================================
-- Beeforce Security Update - Row Level Security (RLS)
-- PLEASE RUN THIS SCRIPT IN YOUR SUPABASE SQL EDITOR
-- ==========================================================

-- Users table: Allow public read so login can find emails, but restrict changes to authenticated users
...
-- Projects table: Restrict all access to authenticated users
